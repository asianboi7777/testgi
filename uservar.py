...
ADDONTITLE     = 'Marvin 4th Gen Wizard'
EXCLUDES       = [ADDON_ID]
# Text File with build info in it.
BUILDFILE      = 'https://asianboi.xyz/4th%20gen%20wizard/autobuilds.txt'
# How often you would list it to check for build updates in days
# 0 being every startup of kodi
UPDATECHECK    = 0
# Text File with apk info in it.  Leave as 'http://' to ignore
APKFILE        = 'https://asianboi.xyz/4th%20gen%20wizard/apk.txt'
...
WIZARDFILE     = 'https://asianboi.xyz/4th%20gen%20wizard/autobuilds.txt'
#########################################################
...
HEADERTYPE     = 'Text'
HEADERMESSAGE  = 'Marvin 4th Gen Wizard'
